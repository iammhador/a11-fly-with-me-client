...
const Footer = () => {
  return (
    <div>
      <footer aria-label="Site Footer" className="bg-accent">
        <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              <div className="flex items-center">
                <img src={logo} alt="" className="mr-3 w-10 h-10" />
                <p className="text-primary text-3xl font-bold">Fly With Me</p>
              </div>

              <p className="mt-4 max-w-xs text-sm text-gray-500 text-left">
                Make You Travel Day Memorable With Experience Guide.
              </p>
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
              ...
              <div>
                <p className="font-bold text-primary">Helpful Links</p>
